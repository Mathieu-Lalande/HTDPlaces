...
namespace HTDPlaces.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,StartDate,EndDate,Location")] Event @event)
        {
            if (ModelState.IsValid)
            {
                // Le createur de l'evenement est l'utilisateur connecte
                var userEntity = await _userManager.GetUserAsync(User);
                if (userEntity != null)
                {
                    @event.Creator = userEntity;
                }
        ...
        {
            return _context.Events != null && _context.Events.Any(e => e.Id == id);
        }
    }
}
